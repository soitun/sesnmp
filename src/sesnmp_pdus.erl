...
dec_rest_v1_v2_msg(Vsn, Rest1) ->
    ...
    PDU = dec_pdu(Rest2),
    #message{version = Vsn, community = Community, data = PDU}.

dec_rest_v1_v2_msg_only(Vsn, Rest1) ->
    {Community, Rest2} = dec_oct_str_tag(Rest1),
    #message{version = Vsn, community = Community, data = Rest2}.
...
%    {MsgSecurityParameters, Bytes2} = dec_oct_str_tag(Bytes1),
    ...
    V3Hdr = #v3_hdr{msgID = MsgID,
		    ...
		    hdr_size = HdrSize},
    #message{version = 'version-3', community = V3Hdr, data = Bytes2}.
...
enc_message(#message{version = Ver, community = VsnHdr, data = Data}) ->
...
enc_message_only(#message{version = Ver, community = VsnHdr, data = DataBytes}) ->
    VerBytes = enc_version(Ver),
    Bytes = 
	case Ver of
	    'version-3' ->
